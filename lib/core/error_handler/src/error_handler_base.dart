...
import 'package:test_dio/core/error_handler/src/filters/network_exception_filter.dart';
import 'package:test_dio/core/error_handler/src/network_exception/network_exception_extension.dart';

// singleton instance of errorHandler
const errorHandler = ErrorHandler(logger: stateLogger);
